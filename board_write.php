...
<div class=box>
    ...
    <div class=wrapper>
        <div class=info>WRITE</div>
        <form method="post" action="board_write_ok.php" enctype="multipart/form-data" autocomplete="off">
        <div class=title><input type=text size=25 name=title placeholder="제목" required></div>
        <div class=content><textarea cols=35 rows=15 name=content placeholder="내용을 입력하세요" required></textarea></div>
